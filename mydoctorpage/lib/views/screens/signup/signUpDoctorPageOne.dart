      ...
      child: Scaffold(
        body: Stack(
          children: [
            ...
            // Form Content inside the ListView
            Padding(
                ...
                child: Form(
                  ...
                  child: Column(
                    children: [
                      ...
                      const Text(
                        "Créer un compte - Docteur", // Translated title
                        style: TextStyle(
                      ...
                      CustomTextField(
                        ...
                        validator: (value) => value == null || value.length < 6
                            ? 'Le mot de passe doit contenir au moins 6 caractères' // Translated error message
                            : null,
                      ),
                      const SizedBox(
                          height: 15), // Reduced space between fields
                      CustomTextField(
                        ...
                        icon: Icons.lock,
                        hintText:
                            'Confirmer le mot de passe', // Translated hint text
                        isPassword: true,
                        validator: (value) => value != passwordController.text
                            ? 'Les mots de passe ne correspondent pas' // Translated error message
                            : null,
                      ),
                      const SizedBox(height: 20),
                      ElevatedButton(
                      ...
                      TextButton(
                        ...
                        child: const Text(
                          'Vous avez un compte? Se connecter', // Translated text
                          style: TextStyle(
