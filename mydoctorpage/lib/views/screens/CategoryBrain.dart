...
class CategoryBrainPage extends StatefulWidget {
  const CategoryBrainPage({super.key});

  @override
  _CategoryBrainPageState createState() => _CategoryBrainPageState();
}

class _CategoryBrainPageState extends State<CategoryBrainPage> {
      ...
      body: ListView(
        ...
        children: [
           const CategoryCard(
            ...
            description: "Choisissez le docteur qui vous convient, spécialisé en cardiologie",
